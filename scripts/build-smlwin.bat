...
call build-msvc --src smlwin.c --libs "smlwin.obj kernel32.lib user32.lib" --output smlwin.exe --working-dir "C:\Code\sml\apps\smlwin" --entry WinMain --subsystem WINDOWS --32 --compressor %option_compressor% --size-record-path %option_size_record_path%
