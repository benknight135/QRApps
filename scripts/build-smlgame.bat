...
call build-msvc --src smlgame.c --libs "smlgame.obj kernel32.lib user32.lib gdi32.lib" --output smlgame.exe --working-dir "C:\Code\sml\apps\smlgame" --entry WinMain --subsystem WINDOWS --32 --compressor %option_compressor% --size-record-path %option_size_record_path%
